...
def github_create_repo() -> None:
    ...
    body_json = {
        "name": "metabook",
        "description": "rename and organize your pdf book collection"
    }
...
def github_create_secret(secret_name: str, secret_value: str) -> None:
    ...
    url_public_key = (
        ...
        "/metabook/actions/secrets/public-key"
    )
    ...
    if r.status_code == 200:
        ...
        url_secret = (
            ...
            f"Stephen-RA-King"
            f"/metabook/actions/secrets/{secret_name}"
        )
...
def readthedocs_create() -> None:
    ...
    body_json = {
        "name": "metabook",
        "repository": {
            "url": "https://github.com/Stephen-RA-King" "/metabook",
            "type": "git",
        },
...
def readthedocs_update() -> None:
    ...
    url = "https://readthedocs.org/api/v3/projects/metabook/"
    header = {"Authorization": f"token {READTHEDOCS_TOKEN}"}
...
def main() -> None:
    ...
    file_path = r"\metabook\Lib\site-packages\semantic_release\repository.py"
